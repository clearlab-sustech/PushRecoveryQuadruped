...
private:
  ...
  DMat<float> Aa, Ba, Sx, Su, f_opt_traj, f_traj, Q_w, R_w, x_predict;
  Eigen::Matrix<float, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> H_traj;
  DVec<float> x_next;
  double v_opt_traj;
  ...
  ofstream csvLog, foot_hold_log;
  bool first_run = false;
  bool get_shirt_iter = false;
  int shirt_iter = 0;
};
