...
public:
  ...
  void run(CheetahVisualization *visualization = nullptr)
  {
    ...
    // csvLog << std::endl;
    csvLog << vWorld(0) << "," << vWorld(1) << "," << vWorld(2) << "," << acc(0) << "," << acc(1) << "," << acc(2) << ","
           << _data.result->vWorld(0) << "," << _data.result->vWorld(1) << "," << _data.result->vWorld(2) << ","
           << _data.result->aWorld(0) << "," << _data.result->aWorld(1) << "," << _data.result->aWorld(2) << std::endl;
  }
