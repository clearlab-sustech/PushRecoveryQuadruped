...
#define TIMEFORRECOVERY 4
#define KNEE_JOINT_LIMIT_L 0.0
#define KNEE_JOINT_LIMIT_U 2.6
#define ABAD_JOINT_LIMIT 0.3
...
public:
  ...
  int contactViolation = 0;
  double vx, vy;
  Eigen::MatrixXd results;
  void testForPushRecovery();
...
private:
  ...
  double _timeOfNextPushRecovery = TEST_TIMING;  //locomotion mode starts at 4.0 s, 6.715s, 6.790, 6.865, 6.940
