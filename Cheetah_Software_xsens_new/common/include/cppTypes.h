...
template <typename T>
using Vec21 = Eigen::Matrix<T, 21, 1>;
...
// 40x1 vector
template <typename T>
using Vec40 = Eigen::Matrix<T, 40, 1>;

template <typename T>
using Vec47 = Eigen::Matrix<T, 47, 1>;

template <typename T>
using Vec48 = Eigen::Matrix<T, 48, 1>;

template <typename T>
using Vec254 = Eigen::Matrix<T, 254, 1>;

template <typename T>
using Vec10000 = Eigen::Matrix<T, 10000, 1>;
