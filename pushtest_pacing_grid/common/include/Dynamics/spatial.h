...
namespace spatial {
    ...
    enum class JointType {
        Prismatic, Revolute, FloatingBase, Fixed, Nothing
    }; // TODO: Check it diff with ros joint type
//    enum class JointType {
//        Nothing, Revolute, Continued, Prismatic, FloatingBase, Planar, Fixed
//    };
 ...
 */
    ...
    SVec<T> jointMotionSubspace(JointType joint, CoordinateAxis axis) {
        ...
        if (joint == JointType::Prismatic)
            ...
            // TODO: Check Fixed type joint
            phi.template setOnes();
//            phi.template topLeftCorner<3, 1>() = v;
        else
