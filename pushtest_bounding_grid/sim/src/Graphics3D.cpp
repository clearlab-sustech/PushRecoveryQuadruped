...
static constexpr auto clearColor = ysplike;
...
void Graphics3D::paintGL()
{
  ...
  painter2.fillRect(QRect(30, 30, 400, 150), QColor(100, 100, 100, 220));
  QFont font("Monospace", 11);
  painter2.setPen(QColor(210, 100, 100));
  painter2.setFont(font);
  painter2.drawText(QRect(30, 35, 1000, 1000), Qt::AlignLeft,
                    QString(infoString));
  painter2.end();
...
void Graphics3D::_DrawContactForce()
{
  ...
  {
    glColor4f(50.0f / 256.0f, 210.0f / 256.0f, 51.0f / 256.0f, 0.5f);
